...
export function FaqSection() {
  return (
    <section className="surface-card mx-auto mt-5 max-w-4xl p-4 sm:p-5 md:p-7" aria-labelledby="faq-title">
      ...
      <p className="mt-1 max-w-2xl text-sm leading-5 text-stone-600 sm:mt-2 sm:text-base sm:leading-6">
        Tout ce qu&apos;il faut savoir pour bien utiliser le calculateur et réduire sa facture d&apos;électricité.
      </p>

      <div className="mt-6 space-y-3">
        {faqs.map(({ question, answer }) => (
          <details
            className="group surface-sub rounded-2xl p-4 open:bg-white"
            key={question}
          >
