...
export function SettingsModalRow({
  ...
  return (
    <>
      ...
      <dialog
        ref={dialogRef}
        className="m-auto w-full max-w-md rounded-[var(--cycle-radius-lg)] bg-white p-0 shadow-2xl backdrop:bg-stone-950/50 backdrop:backdrop-blur-sm"
        onClick={(event) => {
        ...
        <div className="max-h-[85vh] overflow-y-auto p-5 sm:p-6">
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0">
              ...
              {modalDescription && (
                <p className="mt-1 text-sm text-stone-600">{modalDescription}</p>
              )}
            </div>
            <button
              aria-label="Fermer"
